...
def main():
    ...
    #######################
    light_system = LightSystem(light_port, blue_threshold_on_line=9)
    ultra_sonic_sensor = SimpleUltraSonic(ultra_sonic_port, 100)
    ...
    drive_system.move_distance(570)
    ...
    drive_system.move_distance(250)
    # drive_system.rotate_angle(-90)
    # drive_system.rotate_angle_gyro(-81)
