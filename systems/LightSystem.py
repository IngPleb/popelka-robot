...
def is_ball(r, g, b):
    return (r + g + b) > 30 or b > 40


class LightSystem:
    def __init__(self, sensor_port, blue_threshold_on_line, dead_zone=2, initial_correction_magnitude=1,
        ...
        self.correction_direction = -1  # Random initial direction
